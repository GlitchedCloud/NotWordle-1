...
<div class="outer">
	<div class="settings-top">
		...
		<div class="links">
			<a href="https://github.com/KailebAylett/NotWordle" target="_blank">Leave a ⭐</a>
			<a href="https://github.com/KailebAylett/NotWordle/issues" target="_blank">Report a Bug</a>
		</div>
	</div>
</div>
